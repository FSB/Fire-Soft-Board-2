...
/*
** +---------------------------------------------------+
** | Name :		~/main/forum/forum_userlist.php
** | Begin :	29/09/2005
** | Last :		25/12/2007
** | User :		Genova
	...
	*/
	public function show_userlist()
	{
		...
		Fsb::$tpl->set_vars(array(
			...
			'LIST_SEARCH' =>			Html::create_list('like', $this->like, $list_like),
			'LIST_ORDER' =>				Html::create_list('order', $this->order, $order_list),
			'LIST_DIRECTION' =>			Html::create_list('direction', $this->direction, $direction_list),
