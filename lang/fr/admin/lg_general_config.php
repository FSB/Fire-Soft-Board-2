...
return (array (
    ...
    'adm_config_notepad' => 'Bloc-notes',
    'adm_config_notepad_explain' => 'Le quota de notes définit le nombre maximum de notes qu\'un membre peut avoir dans son bloc-notes. Cette limite est faite pour éviter que les notes n\'encombrent trop la base de données. Les administrateurs ne sont pas affectés par ce quota.',
    'adm_config_notepad_quota' => 'Quota de notes dans le bloc-notes',
    'adm_config_notes_per_page' => 'Nombre de notes par page dans le bloc-notes',
