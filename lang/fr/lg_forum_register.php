...
/*
** +---------------------------------------------------+
** | Name :		~/lang/fr/lg_forum_register.php
...
return (array (
 ...
 cookies pour accéder au forum, en effet si vous ne les acceptez pas, il se peut que vous ne puissiez pas vous connecter.<br /><br />Cordialement, l\'équipe du forum.',
  ...
  'register_need_login' => 'Vous devez entrer un pseudonyme pour vous enregistrer',
  ...
  'register_ban_login' => 'Ce pseudonyme est banni, vous ne pouvez l\'utiliser',
